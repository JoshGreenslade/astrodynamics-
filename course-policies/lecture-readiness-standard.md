...
- The chapter includes a progression check demonstrating net-new content relative to the immediately previous lecture (beyond retrieval recap).
...
- Exercises explicitly identify competency-domain coverage; Module 01 Chapter 01 must include assessable C1 and C2 items.
